				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="课程名"
							value="${course.courseName }" readonly="readonly">
					</div>
					<div style="clear: both"></div>
					<div class="col-md-2 title">图片路径</div>
					<div class="col-md-10 data">
						<input type="text" class="form-control" placeholder="图片路径"
							value="${course.imageUrl }" readonly="readonly">
					</div>
					<div style="clear: both"></div>
					<div class="col-md-2 title">视频路径</div>
					<div class="col-md-10 data">
						<input type="text" class="form-control" placeholder="视频路径"
							value="${course.videoUrl }" readonly="readonly">
					</div>
					<div style="clear: both"></div>
					<div class="col-md-2 title rowHeight2x">课程详情</div>
					<div class="col-md-10 data rowHeight2x">
						<textarea class="form-control" rows="3" placeholder="课程详情" readonly="readonly">${course.detail }</textarea>
					</div>
				...
				<table id="dataList"
					...
					<tbody>
						<c:forEach var="comment" items="${course.comments}">
							<tr>
								<td><input type="text" class="form-control" value="${comment.userInfo.username}"
										   readonly="readonly"></td>
								<td><input type="text" class="form-control" value="${comment.detail}"
									readonly="readonly"></td>
								<td><input type="text" class="form-control" value="${comment.publishedTimeStr}"
									readonly="readonly"></td>
							</tr>
						</c:forEach>
					</tbody>
