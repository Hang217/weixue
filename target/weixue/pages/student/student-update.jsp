					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="imgUrl"
								   placeholder="头像路径" value="${user.imgUrl}" readonly="readonly">
						</div>
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="专业"
								   name="specialty" value="${user.specialty}">
						</div>
						...
						<div class="col-md-10 data rowHeight2x">
								<textarea class="form-control" rows="3" placeholder="个人说明"
										  name="elucidation">${user.elucidation}</textarea>
						</div>
