		...
		<div class="content-wrapper">
			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-2 title">年级</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" readonly="readonly"
							   placeholder="年级" value="${user.grade}">
					</div>
					<div class="col-md-2 title">专业</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="专业"
							   readonly="readonly" value="${user.specialty}">
					</div>
			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-10 data rowHeight2x">
							<textarea class="form-control" rows="3" readonly="readonly">${collect.detail}</textarea>
					</div>
					<div style="clear: both"></div>
			...
			<!--课程选择信息-->
			<div class="panel panel-default">
				<div class="panel-heading">课程选择信息</div>
